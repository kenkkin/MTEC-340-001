...
public class PlayerController : MonoBehaviour
{
    ...
    public void RayCastDown()
    {
        ...
        Ray playerRay = new Ray(transform.position, -transform.up);  // Ray playerRay = new Ray(transform.GetChild(0).position, -transform.up);
    ...
    private void OnDrawGizmos()
    {
        ...
        Ray ray = new Ray(transform.position, -transform.up); // Ray ray = new Ray(transform.GetChild(0).position, -transform.up); 
        Gizmos.DrawRay(ray);
    }
